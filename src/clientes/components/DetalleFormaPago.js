...
export const DetalleFormaPago = ({clases = '', detalle, handleGuardar = ()=>{}, handleDescartar = ()=>{}}) => {
    ...
    return(
        ...
        <div className='forma-de-pago__detalle__botones'>
            <button onClick={()=>handleGuardar(detalleState)} className='forma-de-pago__detalle__botones__guardar simple-hover'>Guardar</button>
            <button onClick={handleDescartar} className='forma-de-pago__detalle__botones__descartar simple-hover'>Descartar</button>
        </div>
