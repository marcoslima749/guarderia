...
createPortal(   <div className="ctacte-impresion__background">
                  <div className="ctacte-impresion__container">
                      <div className="ctacte-impresion__header">
                        <div className="ctacte-impresion__header-izquierda">
                        ...
                        <div className="ctacte-impresion__header-derecha">

                          <h3 className="ctacte-impresion__cliente">Cliente: {numeroCliente} - {nombreCliente}</h3>
                          <h3 className="ctacte-impresion__periodo">01/01/2018 al {moment(Date.now()).format('DD[/]MM[/]YYYY')}</h3>
